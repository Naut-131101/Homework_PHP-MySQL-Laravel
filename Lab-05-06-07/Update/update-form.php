...
<body>
    ...
    <main>
        <?php
            ...
            $idErr = $nameErr = $mssvErr = $ageErr = $birthdayErr = $phoneErr = $emailErr = $addressErr = $genderErr = $descriptionErr = "";
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                if(empty($_POST["id"])) {
                    ...
                    if (!preg_match("/^[0-9]*$/",$id)) { // Dieu kien check tuoi
                    $idErr = "Only number (0-9) allowed";
                    }
                }
                // Check name
                if(empty($_POST["name"])) {
        ...
        <form action="<?php echo $action;?>" method="post">
            ...
            <div id="id">
                ...
                <span class="error" style="color: red;">* <br> <?php echo "$idErr";?></span>
            </div>
            <!-- Name -->
            <div id="name">
